...
float64 r7 = 1.1                   // OK
float32 r8 = 1.1                   // Illegal
    // 1.1 is stored in the compiler as a float64 and
    // cannot be converted to float32 without losing
    // precision.
float32 r8 = 1.125                 // OK
    // 1.125 is stored precisely as a float64, because
...
float64 r4 = float64(x)            // OK; precision may be lost
float32 r5 = float32(y)            // OK; precision may be lost;
                                   //     some values may be
