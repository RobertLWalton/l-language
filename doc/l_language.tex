...
An out-of-line function call begins by allocating a block in the
local stack to hold
...
the blocks it allocated ti the local stack are deallocated.
...
allocated to the global stack.  This allows addresses of
