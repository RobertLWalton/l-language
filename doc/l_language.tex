...
The \key{lifetime depth} 
of an assignment variable is determined mostly by the \key{statement depth}
...
Given this, the rules for assigning depth to variables are:
\begin{indpar}[0.2in]
\begin{tabular}{lp{5.0in}}
...
\\[1ex]
		& In addition, a {\em reference-expressions}
