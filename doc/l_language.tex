...
and {\em reference-expressions} inclusing those that are bases for
...
If the {\em expression} is a {\em constant}\pagnote{CONSTANTS} other than
a {\em rational-constant}, evaluate
...
If the {\em expression} has the form: \\
...
If the {\em expression} is a {\em function-call},
