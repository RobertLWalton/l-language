...
be implicitly converted to the target type, except for pointer
type conversions.  However a function call that returns a {\tt const}
result is replaced by its value at compile time, and this value
can be implicitly converted to the target type.
