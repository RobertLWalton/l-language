...
(beginning with \TT{@}), the reference pointer computed by the
...
real reference pointer produced by the base of the
compound {\em reference-expression}.
\end{itemize}
...
The type of any ({\em function-}){\em variable-name} that is the root
