...
(see Call-Prototype Matching Algorithm below).
If there are 0, go to the next step in this algorithm.
If there are more than 1, apply the Call-Prototype Rank Elimination
Algorithm below.
...
whose {\em function-prototype} matches {\em function-call} $e$
(see Call-Prototype Matching Algorithm below)
...
apply the Call-Prototype Rank Elimination Algorithm below.
