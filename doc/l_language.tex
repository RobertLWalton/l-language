...
Set of fields, subfields, and labels of the defined type is
the union of those defined by any {\em type-declaration} in the defined
type's expansion tree.
...
must be set by an {\tt *ORIGIN*} statement before it is used if
the {\em type-declaration} is a non-root.
...
current offset values previously computed in the current {\em type-declaration}
