...
call-prototype match fails.  If $AA$ is a reference expression, the
...
\item Matches between {\em prototype-argument-declaration} types
...
{\tt function float64 r = std float64 (N v1)}
\end{indpar}
...
int32 x = ...
float64 r1 = x + 5
    // Target type float64 selects N = float64 for "+".
bool b1 = ( x == 5 )
...
bool b2 = ( x == y )
    ...
    // N = float64 for "==";  N = int32 version of "=="
    // fails when it tries to implicitly convert y to
    // int32.
bool b2 = ( float64 ( x ) == 5 )
    // All float64 functions have float64 result type,
    // and as there is no implicit conversion of float64
    // function results, "==" must have N = float64.
    // The only float64 function with *EXACT* argument
...
{\tt function const r = (const v1) \ttkey{"=="} ( const v2 )} \\
{\tt function const r = (const v1) \ttkey{"!="} ( const v2 )}
\begin{indpar}
...
{\tt function const r = \ttkey{type} ( const v1 )}
\begin{indpar}
...
{\tt function const r = \ttkey{number} ( const v1 )} \\
{\tt function const r = \ttkey{rational} ( const v1 )}
\begin{indpar}
...
{\tt function const r = \ttkey{"+"} ( const n1 )} \\
{\tt function const r = \ttkey{"-"} ( const n1 )} \\
{\tt function const r = (const n1) \ttkey{"+"} ( const n2 )} \\
{\tt function const r = (const n1) \ttkey{"-"} ( const n2 )} \\
{\tt function const r = (const n1) \ttkey{"*"} ( const n2 )} \\
{\tt function const r = (const n1) \ttkey{"/"} ( const n2 )}
\begin{indpar}
...
{\tt function const r = (const i1) \ttkey{"\&"} ( const i2 )} \\
{\tt function const r = (const i1) \ttkey{"|"} ( const i2 )} \\
{\tt function const r = (const i1) \ttkey{"\textasciicircum"} ( const i2 )} \\
{\tt function const r = (const i1) \ttkey{"<{}<"} ( const i2 )} \\
{\tt function const r = (const i1) \ttkey{">{}>"} ( const i2 )}
\begin{indpar}
...
{\tt function const r1, const r2 = \ttkey{floor} (const n1, const n2 )} \\
{\tt function const r1, const r2 = \ttkey{ceiling} (const n1, const n2 )} \\
{\tt function const r1, const r2 = \ttkey{truncate} (const n1, const n2 )} \\
{\tt function const r1, const r2 = \ttkey{round} (const n1, const n2 )}
\begin{indpar}
...
{\tt function const r =} \ttkey{numerator} {\tt ( const r1 )} \\
{\tt function const r =} \ttkey{denominator} {\tt ( const r1 )}
\begin{indpar}
These functions return the numerator and denominator of a rational.
Both numerator and denominator are integer {\tt rationals}.
\end{indpar}

{\tt function const r =} \ttkey{is nan} {\tt ( const v1 )}
\begin{indpar}
...
{\tt function const r =} \ttkey{"\#"} {\tt ( const s )}
\begin{indpar}
...
{\tt function const r =} (const s1) \ttkey{"+"} {\tt ( const s2 )}
\begin{indpar}
Returns the concatenation of string {\tt s1}
and string {\tt s2}.
\end{indpar}

{\tt function const r =} \ttkey{sprintf}
    {\tt ( \begin{tabular}[t]{@{}l}
...
{\tt function const r =} \ttkey{explode} {\tt ( const s )}
\begin{indpar}
...
{\tt function const r =} \ttkey{implode} {\tt ( const m )}
\begin{indpar}
...
{\tt function const r =} \ttkey{compile re} ( const s )
\begin{indpar}
...
{\tt function const r =} \ttkey{match re} ( const i, const s  )
\begin{indpar}
...
{\tt function const r =} \ttkey{scan} ( const s  )
\begin{indpar}
...
{\tt function const r =} \ttkey{parse brackets} ( const s  )
\begin{indpar}
...
{\tt function const r =} \ttkey{parse} ( const s  )
\begin{indpar}
Equivalent to {\tt \{* {\rm \em value of} s *\}}.
...
{\tt function const r =} \ttkey{read-write} {\tt ( const m )} \\
{\tt function const r =} \ttkey{read-only} {\tt ( const m )}
\begin{indpar}
...
{\tt function const r =} \ttkey{read-write} {\tt ( const m, const s )} \\
{\tt function const r =} \ttkey{read-only} {\tt ( const m, const s )} %
...
{\tt function const r =} \ttkey{"\#"} {\tt ( const m )}
\begin{indpar}
...
{\tt function const r =} \ttkey{labels} {\tt ( const m )}
\begin{indpar}
...
{\tt function const r =} {\tt ( const m ) [ const s ]}
\begin{indpar}
...
{\tt function const r =} \ttkey{copy} {\tt ( const m )} \\
{\tt function const r =} \ttkey{copy top} {\tt ( const m )} %
\label{MAP-COPY}
\begin{indpar}
...
{\tt function const r =} \ttkey{duplicate} {\tt ( const m )} \\
{\tt function const r =} \ttkey{duplicate top} {\tt ( const m )}
\begin{indpar}
Ditto, but if any read-only map is to be copied, the pointer
to the map is copied and no new map is made.
\end{indpar}

{\tt function const r =} \ttkey{slice} {\tt ( const m, const i, const n )}
\begin{indpar}
...
{\tt function const r =} \ttkey{splice}
...
{\tt function const r =} \ttkey{truncate} {\tt ( const m, const i )}
\begin{indpar}
...
\begin{itemlist}[0.5in]
\item[\tt function int\ldots{}~r1 = *UNCHECKED* ( N1 v )]
\item[\tt function uns\ldots{}~r1 = *UNCHECKED* ( N1 v )] \vspace*{-0.1in}
\item[\tt function bool = *UNCHECKED* ( N1 v )] \vspace*{-0.1in} ~\\
...
{\tt function F r = \ttkey{"+"} ( F v1 )} \\
{\tt function F r = \ttkey{"-"} ( F v1 )} \\
{\tt function F r = (F v1) \ttkey{"+"} ( F v2 )} \\
{\tt function F r = (F v1) \ttkey{"-"} ( F v2 )} \\
{\tt function F r = (F v1) \ttkey{"*"} ( F v2 )} \\
{\tt function F r = (F v1) \ttkey{"/"} ( F v2 )}
\begin{indpar}
...
{\tt function F r = \ttkey{floor} (F v1, F v2 = 1.0 )} \\
{\tt function F r = \ttkey{ceiling} (F v1, F v2 = 1.0 )} \\
{\tt function F r = \ttkey{truncate} (F v1, F v2 = 1.0 )} \\
{\tt function F r = \ttkey{round} (F v1, F v2 = 1.0 )}
\begin{indpar}
Where {\tt F} is one of {\tt flt}, {\tt flt64}, or {\tt flt32}.
...
{\tt function bool r = (F v1) \ttkey{"=="} ( F v2 )} \\
{\tt function bool r = (F v1) \ttkey{"!="} ( F v2 )} \\
{\tt function bool r = (F v1) \ttkey{"<"} ( F v2 )} \\
{\tt function bool r = (F v1) \ttkey{"<="} ( F v2 )} \\
{\tt function bool r = (F v1) \ttkey{">"} ( F v2 )} \\
...
{\tt function bool r =} \ttkey{is nan} {\tt ( F v1 )} \\
{\tt function bool r =} \ttkey{is infinity} {\tt ( F v1 )} \\
{\tt function bool r =} \ttkey{is finite} {\tt ( F v1 )}
\begin{indpar}
...
{\tt function FP flags r =} \ttkey{FP flags register} \\
{\tt function} \ttkey{FP flags register} {\tt = FP flags v}
\begin{indpar}
...
{\tt function I r, bool cout, bool ovfl = \ttkey{"+"} ( I v1, bool cin = 0 )} \\
{\tt function I r, bool cout, bool ovfl = \ttkey{"-"} ( I v1, bool cin = 1 )} \\
{\tt function I r, bool cout, bool ovfl =
    (I v1) \ttkey{"+"} ( I v2, bool cin = 0 )} \\
{\tt function I r, bool cout, bool ovfl =
    (I v1) \ttkey{"-"} ( I v2, bool cin = 1 )}
\begin{indpar}
Where {\tt I} is one of:
	\begin{tabular}[t]{l}
...
{\tt function I r = (I v1) \ttkey{"*"} ( I v2 )} \\
{\tt function U r, U cout = (U v1) \ttkey{"*"} ( U v2, U cin1 = 0, U cin2 = 0 )}
\begin{indpar}
Where {\tt I} is one of:
	\begin{tabular}[t]{l}
...
{\tt function I r = (I v1) \ttkey{"/"} ( I v2 )} \\
{\tt function U r, U cout = (U v1, U cin = 0) \ttkey{"/"} ( U v2 )}
\begin{indpar}
Where {\tt I} is one of:
	\begin{tabular}[t]{l}
	\tt int  int128 int64  int32  int16 \\
...
{\tt function I r =        \ttkey{"\textasciitilde"} ( I v1 )} \\
{\tt function I r = (I v1) \ttkey{"\&"} ( I v2 )} \\
{\tt function I r = (I v1) \ttkey{"|"} ( I v2 )} \\
{\tt function I r = (I v1) \ttkey{"\textasciicircum"} ( I v2 )}
\begin{indpar}
Where {\tt I} is one of:
	\begin{tabular}[t]{l}
	\tt int  int128 int64  int32  int16 int8 \\
...
{\tt function I r = (I v1) \ttkey{"<{}<"} ( int v2 )} \\
{\tt function I r = (I v1) \ttkey{">{}>"} ( int v2 )}
\begin{indpar}
Where {\tt I} is one of:
	\begin{tabular}[t]{l}
...
{\tt function bool r = (I v1) \ttkey{"=="} ( I v2 )} \\
{\tt function bool r = (I v1) \ttkey{"!="} ( I v2 )} \\
{\tt function bool r = (I v1) \ttkey{"<"} ( I v2 )} \\
{\tt function bool r = (I v1) \ttkey{"<="} ( I v2 )} \\
{\tt function bool r = (I v1) \ttkey{">"} ( I v2 )} \\
