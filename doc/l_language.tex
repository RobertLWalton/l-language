...
my type Z:       // A virtual pointer @Z is computed to the variable Z.
    Z.X = 5      // A virtual ponter to Z.X is computed and dereferenced.
    Z.@Y = null  // A virtual ponter to Z.@Y is computed and dereferenced.
