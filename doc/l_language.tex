...
first allocates and initializes
memory for the variables declared by the {\em block-variable-declarations}.
...
Other declarations zero the memory if they are not {\em next-declarations},
and set the memory to the previous value of the declaration's variable if
...
Note that variables whose declarations have
\underline{no} {\em allocation-call},
...
Within the {\em statements} and {\em exit-subblocks}
