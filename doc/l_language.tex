...
\hline
\ttkey{if} & conditional & prefix & control & 0000
\\\cline{1-1}
\ttkey{else if} & & & &
\\\cline{1-2}
\ttkey{while} & loop & & &
...
\ttkey{until} & & & &
\\\cline{1-3}
\ttkey{else} & conditional & initial & &
\\\cline{1-3}
\ttkey{:} operator & completes & afix & &
\\\cline{1-1}\cline{3-3}
\ttkey{:} indentation & conditional & afix & & \\
~~mark                & & postfix & &
\\\hline
