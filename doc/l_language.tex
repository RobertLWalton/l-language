...
Maps \underline{cannot} be represented at run-time.  Each {\em map-constant}
...
A map has a \key{read-only flag}\label{READ-ONLY-FLAG}
which is set when the map is created
