...
When code requiring an {\em defined-type-name} to be non-expandable is
compiled, the compiler assumes that the {\em defined-type-name} is in fact
non-expandable at the point of the code,
...
Note that this applies only to RAM memory, and not to input/output
device memory.
\end{enumerate}
\end{indpar}
