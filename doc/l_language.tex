...
{\em type-declarations} that are expansions of an
external {\em type-declaration}, and companions of external deferred
...
sub-declaration must have external {\em defined-type-names}
...
but must have a {\em defined-type-name} that references the same module
...
{\em type-declaration} and the entirety of all
...
Textually it is:
\begin{center}
\{ {\em pointer-type-name} {\em qualifier-name}\STAR{} \}\PLUS{}
\{ {\em type-name} $|$ {\em function-type-name} \}
\end{center}
