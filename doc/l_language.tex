...
size of the type in bytes (which may increase with later sub-declarations).
...
Explicit conversion from values of number type {\tt N1} to values
...
Unchecked explicit conversion from values of number type {\tt N1} to values
