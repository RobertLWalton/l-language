...
will not see data corrupted by the atomic write of B.

To release the lock, the writing process just atomically
writes the value of B into A.  Because the write is atomic, all reads and
...
the atomic reads of A and B, and also the values read will not be
