...
itself is the value of the {\em reference-expression}, and can cannot
...
\end{enumerate}
\item If $P$ is a {\tt dp} pointer pointing at a user defined type and the
...
\item If $P$ is an {\tt ap} pointer pointing at a user defined type and the
...
Run-time {\em reference-offset} indices have the target type {\tt int}.
