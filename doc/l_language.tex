...
In the following, suppose we are given:
\begin{indpar} \tt
pointer type $P1$ is $D1$ \\
pointer type $P2$ is $D2$
\end{indpar}

To get more complete access to the value pointed at one
can define a function with the prototype:
\begin{indpar} \tt
...
be accessed.  Then if $P2$ is {\tt dp}, {\tt ap}, {\tt fp}, {\tt av},
...
You can define a function with prototype
\begin{indpar} \tt
...
\hspace*{0.3in}r = *UNCHECKED* ( d2 )
\end{indpar}
Similarly, defining a function with prototype
\begin{indpar} \tt
