...
\begin{indpar}
{\tt N r = std (N v1) "+" ( N v2 )} \\
{\tt bool r = std (N v1) "==" ( N v2 )} \\
{\tt float64 r = std float64 (N v1)}
\end{indpar}
...
{\tt I r =        \ttkey{"\textasciitilde"} ( I v1 )} \\
{\tt I r = (I v1) \ttkey{"\&"} ( I v2 )} \\
{\tt I r = (I v1) \ttkey{"|"} ( I v2 )} \\
{\tt I r = (I v1) \ttkey{"\textasciicircum"} ( I v2 )}
\begin{indpar}
Where {\tt I} is one of:
	\begin{tabular}[t]{l}
	\tt int  int128 int64  int32  int16 int8 \\
