...
reference expressions are made by appending vector indices or
{\em member-names} optionally followed by other arguments
to more basic {\em reference-expressions}.  The syntax
is:
