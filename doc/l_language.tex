...
//
//    av Q$1 PST$1 @r = std *UNCHECKED* ( ap Q$1 PST$2 @p )
//
...
{\em function-call} to call the function.  Instead it is a
{\em variable-name} that names a {\tt co} constant valued variable
