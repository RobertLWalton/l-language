...
If the subexpression is a {\em reference-expression} or a
{\em const-expression} $e$ whose type is not
...
(after $e$ is replaced by its value if it is a {\em const-expression}).
