...
When called, the macro function in a {\em macro-statement}
the parsed {\em macro-statement} is the value of the
...
which signals the compilation of the {\em macro-statement}
...
which must be a {\em function-call} to another macro function.
