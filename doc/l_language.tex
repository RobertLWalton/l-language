...
also annotate $E$ with the value of the variable.  Then
terminate this algorithm.

Note that is $E$ is a left {\em reference-expression} naming a
variable that cannot be read (e.g., an {\tt *INIT*} variable),
or $E$ is a right {\em reference-expression} naming a variable
...
with a {\tt const} value), it is a compile error.
...
search for non-special
{\em reference-function-declarations} matching $E$.  If a declaraton $D$
is found,
annotate $E$ with $E$ and the result type of $D$ and terminate
this algorithm.
...
a compound {\em reference-expression}
(whose base will be annotated with a type by this point),
evalute the type $E$, annotate $E$ with this type, and
terminate this algorithm.
