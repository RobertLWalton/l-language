...
the actual argument matched to the {\em reference-pattern-base}.
At compile time the type of the reference pointer produced by this
base argument has been computed by recursion, and at run-time
