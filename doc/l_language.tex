...
In this section {\tt macro}, {\tt constant}, and {\tt inclusion}
functions will be called \key{special functions}.
...
When a parsed {\em function-call} is first processed, it must be
processed to see if it is a call to a {\tt macro}, {\tt constant}, or
{\tt inclusion} function.  This processing in turn memoizes the following:
...
More specifically, when a parsed {\em function-call} is first processed,
The following algorithm is applied:

\bigskip

\centerline{\bf Call-Prototype First Encounter Algorithm}
\begin{enumerate}
...
value representing a \underline{parsed} {\em expression}. Then if it is a
...
a particular {\em function-prototype} matches a particular
{\em function-call}:
