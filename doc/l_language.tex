...
{\tt F r1, F r2 = \ttkey{floor} (F v1, F v2 )} \\
{\tt F r1, F r2 = \ttkey{ceiling} (F v1, F v2 )} \\
{\tt F r1, F r2 = \ttkey{remainder} (F v1, F v2 )} \\
{\tt F r1, F r2 = \ttkey{round} (F v1, F v2 )}
\begin{indpar}

These divide {\tt v1} by {\tt v2} and return {\tt r1} as the
result rounded to an integer and {\tt r2} as the remainder.
Here {\tt floor} rounds toward negative infinity, {\tt ceiling}
rounds towards positive infinity, {\tt remainder} rounds toward
zero, and {\tt round} rounds to the nearest integer, or to the
...
\\[1ex]
Return {\tt 1} if {\tt v1} is any NaN number (not just {\tt NaN}), and {\tt 0}
otherwise.
\end{indpar}
