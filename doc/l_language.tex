...
a non-root Y is the {\em type-declaration} X of
smallest scope whose scope contains Y.
...
{\em Type-declarations} that so end are called \key{expandable},
...
scope of that non-expandable {\em type-declaration}.
