...
to any target type, unless this conversion violates
the rules of the last paragraph (e.g., converting `{\tt 1 / 3}'
to an {\tt int}).

Builtin operators, such as `{\tt +}',
have the operands of the same type as their result.
