...
{\tt const r =} \ttkey{sprintf}
    {\tt ( \begin{tabular}[t]{@{}l}
	    ...
	    \end{tabular} }
\begin{indpar}
Returns the string make by applying the UNIX {\tt sprintf} function to the
arguments {\tt a1}, {\tt a2}, {\tt a3}, and {\tt a4} (not all of which need
be used).  Arguments may be numbers or strings.
Rational arguments are converted to numbers first.  Map arguments
are not allowed.
\end{indpar}
