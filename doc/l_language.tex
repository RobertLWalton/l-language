...
ap *READ-WRITE* list element @null1
    // Depth 1 null value.

// Circular list:
//
ap *READ-WRITE* list element @last:  // `@= local' is implied
    last.@successor = @null1
    // Last element is pointed at by last.@successor
    // First element is pointed at by last.successor.@successor
    // Empty list has last.@successor == @null1
...
variables, and any target pointer variable value that is reachable from
