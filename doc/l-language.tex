...
A \ttkey{extendable} sub-declaration must be the last
{\em type-subdeclarations} in a {\em type-declaration}, and specifies
that the {\em type-declaration} may be extended by giving another
{\em type-declaration} with the same
{\em type-name}, whose {\em type-subdeclarations}
will be appended to the current list of such for the {\em type-name}.
...
A {\em defined-type-name} may declared as \key{deferred}, meaning
that its full declaration will appear later.  Such a {\em defined-type-name}
may be used before it is fully declared as the target of a
{\em pointer-type} or with an allocator.
...
always zeroed.  Use as a pointer target is does not require non-deferred
