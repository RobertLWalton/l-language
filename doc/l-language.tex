...
{\tt co}, for `constant', which is the implied default and therefore
...
to the value pointed at, and not to the pointer value.  For example:
...
the subfield name `{\tt op code}' and what L-Language calls the
