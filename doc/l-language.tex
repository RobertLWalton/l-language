...
\emkey{out-of-line-function-declaration}%
	\label{OUT-OF-LINEFUNCTION-DECLARATION}
    ::= \begin{tabular}[t]{l}
...
\hspace*{0.5in}{\em module-abbreviation}\QMARK{}~
	      {\em out-of-line-function-name}~
	      {\em pattern-argument-list}\QMARK{}
\\[0.5ex]
\emkey{out-of-line-function-name} ::= {\em basic-name} $|$ {\em quoted-string}
\\[0.5ex]
