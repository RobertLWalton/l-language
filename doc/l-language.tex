...
must be top level in a module file, except that external
declarations that are not inline {\em function-declarations}
may be have companion declarations anywhere within the scope
