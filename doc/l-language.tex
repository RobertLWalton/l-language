...
\item
{\em Names} of other than qualifiers should not contain {\em qualifier-names}.
\end{enumerate}
\end{indpar}
...
the {\em declaration} up to the end of any {\em block} or file
...
A {\em declaration} is \key{external} if it is top level in a module
(and not in a body), if it
