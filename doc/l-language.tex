...
\skey{external name}s.  Other names are called \skey{internal name}s.
...
\emkey{out-of-line-function-declaration}%
	...
	& \TT{~~~~~}{\em statement}\PLUS{} \\
    $|$ &  {\em out-of-line-function-prototype} \\
    \end{tabular}
\\[2ex]
...
and additionally, if a variable is external, all these later statements must
be in the module named by the variable or the bodies of this module.
...
Some {\em declarations} are \key{external}.  An external declaration
