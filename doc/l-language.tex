...
If the {\em variable-name} at the beginning of a {\em reference-expression}
is a {\em target-variable} with a companion {\em pointer-variable},
...
its companion {\em pointer-variable}.

If the {\em variable-name} at the beginning of a {\em reference-expression}
is a {\em target-variable} \underline{without}
a companion {\em pointer-variable},
...
a {\em target-variable} is implicitly declared at the same time
