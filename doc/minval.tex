...
You \underline{cannot} compute locations of variables within the current
function frame.  For example:
\begin{indpar}\begin{verbatim}
\tt int X = 100
\tt int @ Y = @ X     // Illegal! Takes location of X.
\tt av uns8 Z = Gobbledeegook
\tt uns8 @ W = @ Gobbledeegook[X]
\tt uns8 @ V = @ W    // Legal! Value of W is NOT in function frame,
                      // instead @ W is stored in function frame
                      // and its value can be copied to @ V.
\tt ap uns8 P = @ V   // Legal! Copies location @ V stored in
                      // function frame to P.
