...
\\[0.5ex]
\emkey{pair-label} ::= {\em basic-name}
\end{indpar}
...
Inline functions may be defined that syntactically mimic
{\em reference-expressions}.  An example is:
