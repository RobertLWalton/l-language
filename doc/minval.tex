...
If this statement occurs outside a function declaration,
the variable is allocated to the current module memory, and
may be both read and written.  If this statement occurs
inside a function declaration, the variable is allocated to the
current function frame, and after being initialized
