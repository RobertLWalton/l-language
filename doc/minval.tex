...
\ttkey{|} & binary or & infix & nomix & 9 \\
\ttkey{\&} & binary and & infix & nomix & 9 \\
\ttkey{xor} & binary exclusive or & infix & nomix & 9 \\
...
\ttkey{!} & binary complement & prefix & unary & \\
\hline
...
However arbitrary expressions computing with {\tt cnst} values
...
\tt \TT{!} x & evaluates on signed integers as if they were represented
               in two's complement binary values of unbounded size 
\end{tabular}
\end{indpar}
